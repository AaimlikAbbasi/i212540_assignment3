...
class MessageAdapter(private val mChat: List<Chat>, private val mContext: Context, private val imageURL: String,var onclick:onClickMessage) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var btn_more: ImageView = itemView.findViewById(R.id.btn_more)
        var Voicenoteurl: ImageView = itemView.findViewById(R.id.voiceNoteIcon)
        var chatitem_left=itemView.findViewById<RelativeLayout>(R.id.chatitem_left)
